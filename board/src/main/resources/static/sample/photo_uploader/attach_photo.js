    ...
    function html5Upload() {
    	...
    	for(var j=0, k=0; j < nImageInfoCnt; j++) {
    		console.log(" ~~~~~~~~~~~131313 : tempFile    : " , tempFile)
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
		...
		alert("~~~~~~5 callAjaxForHTML5 끝여기위에서 저장")

		alert("~~~~~~6 callAjaxForHTML5 끝")
    }
    ...
    function makeArrayFromString(sResString){
    	var	aTemp = [],
 		...
 		console.log("dddddd htTemp : " , htTemp)
 		console.log("dddddd aResultleng : " , aResultleng)
		alert("~~~~~~7 ")
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'photoUpload',
 	        sCallback : '/sample/photo_uploader/callback.html',
